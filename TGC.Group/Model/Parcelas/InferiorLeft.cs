...
namespace TGC.Group.Model.Parcelas
{
    class InferiorLeft : Parcela
    {
        ...
        public InferiorLeft(TGCVector3 Position, TgcPlane grassPlane, TgcTexture wallTexture, TgcPlane columnPlaneX, TgcPlane columnPlaneZ, TgcPlane topPlane, TgcMesh plantModel)
        {
