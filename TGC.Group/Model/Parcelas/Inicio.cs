...
namespace TGC.Group.Model.Parcelas
{
    class Inicio : Parcela
    {
        public Inicio(Vector3 position, string grassTexture, string wallTexture, string columnTexture, string topTexture)
        {
            ...
            wallMesh.Position = new Vector3(position.X, position.Y, position.Z + 12.5f);
            wallMesh.UpdateMeshTransform();
            ...
            wallMesh.Position = new Vector3(position.X, position.Y, position.Z + 25);
            wallMesh.UpdateMeshTransform();
            ...
            wallMesh.Position = new Vector3(position.X + 50, position.Y, position.Z + 25);
            wallMesh.UpdateMeshTransform();
