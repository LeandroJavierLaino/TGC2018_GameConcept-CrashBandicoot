...
namespace TGC.Group.Model.Parcelas
{
    ...
    {
        public InferiorRight(TGCVector3 Position, string grassTexture, string wallTexture, string columnTexture, string topTexture, string plantModel)
        {
            ...
            basePlant.Position = new TGCVector3(Position.X + 30, Position.Y, Position.Z + 5);
            ran = random.Next(0, 100);
            basePlant.RotateY(ran);
            ...
            basePlant.Position = new TGCVector3(Position.X + 10, Position.Y, Position.Z + 5);
            ran = random.Next(0, 100);
            basePlant.RotateY(ran);
