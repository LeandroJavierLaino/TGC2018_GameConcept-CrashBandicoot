...
namespace TGC.Group.Model.Parcelas
{
    class InferiorRight : Parcela
    {
        ...
        public InferiorRight(TGCVector3 Position, TgcTexture grassTexture, TgcTexture wallTexture, TgcTexture columnTexture, TgcTexture topTexture, TgcMesh plantModel)
        {
