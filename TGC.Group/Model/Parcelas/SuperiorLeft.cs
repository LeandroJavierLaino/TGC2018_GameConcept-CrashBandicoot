...
namespace TGC.Group.Model.Parcelas
{
    class SuperiorLeft : Parcela
    {
        ...
        public SuperiorLeft(TGCVector3 Position, TgcTexture grassTexture, TgcTexture wallTexture, TgcTexture columnTexture, TgcTexture topTexture, TgcMesh plantModel)
        {
