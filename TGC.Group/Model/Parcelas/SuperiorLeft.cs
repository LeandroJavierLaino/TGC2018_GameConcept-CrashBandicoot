...
namespace TGC.Group.Model.Parcelas
{
    class SuperiorLeft : Parcela
    {
        ...
        public SuperiorLeft(TGCVector3 Position, TgcPlane grassPlane, TgcTexture wallTexture, TgcPlane columnPlaneX, TgcPlane columnPlaneZ, TgcPlane topPlane, TgcMesh plantModel)
        {
