...
namespace TGC.Group.Model.Parcelas
{
    public class Pit : Parcela
    {
        ...
        public Pit(TGCVector3 newPosition, string grassTexture, string wallTexture, string columnTexture, string topTexture)
        {
            ...
            floor = new TgcPlane(new TGCVector3(newPosition.X, newPosition.Y - 20, newPosition.Z), new TGCVector3(50, 0, 50), TgcPlane.Orientations.XZplane, TgcTexture.createTexture(grassTexture), 4, 4).toMesh("floor");
